...
* There are 4 known implementations of the Starlark language:
  * [starlark/java](https://github.com/bazelbuild/bazel/tree/master/src/main/java/net/starlark/java) ⭐ 25,721 | 🐛 1,935 | 🌐 Java | 📅 2026-08-15 - an implementation in Java
  ...
  * [starlark-rust](https://github.com/facebookexperimental/starlark-rust) ⭐ 1,008 | 🐛 39 | 🌐 Rust | 📅 2026-08-14 - an implementation in Rust.
...
* [Buildifier](https://github.com/bazelbuild/buildtools) ⭐ 1,187 | 🐛 117 | 🌐 Go | 📅 2026-07-16 - The official code formatter &
...
* [Bazel](https://github.com/bazelbuild/bazel) ⭐ 25,721 | 🐛 1,935 | 🌐 Java | 📅 2026-08-15 - a fast, scalable,
  multi-language and extensible build system. Starlark has been designed for
  Bazel.
* [Delve](https://github.com/go-delve/delve) ⭐ 24,878 | 🐛 89 | 🌐 Go | 📅 2026-08-13 - a debugger for the Go
  programming language, aiming to provide a simple, full featured debugging
  tool for Go. [Delve uses Starlark](https://github.com/go-delve/delve/blob/master/Documentation/cli/starlark.md) ⭐ 24,878 | 🐛 89 | 🌐 Go | 📅 2026-08-13
  as a a scripting language.
* [Copybara](https://github.com/google/copybara) ⭐ 3,796 | 🐛 105 | 🌐 Java | 📅 2026-08-14 - a tool for transforming and
  moving code between repositories. It embeds Starlark to configure the workflow.
* [envd](https://github.com/tensorchord/envd) ⭐ 2,222 | 🐛 139 | 🌐 Go | 📅 2026-07-25 - a CLI to build the docker images
...
* [OpenRun](https://github.com/openrundev/openrun) ⭐ 934 | 🐛 1 | 🌐 Go | 📅 2026-08-17 - web app development and deployment
  platform for internal tools. It allows declarative deployment of applications built
  in any language/framework.
* [Pixlet](https://github.com/tidbyt/pixlet) ⭐ 847 | 🐛 71 | 🌐 Go | 📅 2026-08-16 - a runtime and UX toolkit for generating animations for small LED displays, such as [Tidbyt](https://tidbyt.com/). Starlark is used to write applets whose outputs are WebP animations.
