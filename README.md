...
* [The language specification](https://github.com/bazelbuild/starlark/blob/master/spec.md) ⭐ 3,064 | 🐛 96 | 🌐 Python | 📅 2026-02-06

* There are 4 known implementations of the Starlark language:
  * [starlark/java](https://github.com/bazelbuild/bazel/tree/master/src/main/java/net/starlark/java) ⭐ 25,710 | 🐛 1,927 | 🌐 Java | 📅 2026-08-14 - an implementation in Java
    built for Bazel, that may not be suitable for use in other applications.
  * [starlark-go](https://github.com/google/starlark-go/) ⭐ 2,745 | 🐛 76 | 🌐 Go | 📅 2026-07-10 - an implementation in Go.
  * [starlark-rust](https://github.com/facebookexperimental/starlark-rust) ⭐ 1,006 | 🐛 38 | 🌐 Rust | 📅 2026-08-14 - an implementation in Rust.
...
* Bindings:
  ...
  * [python-starlark-go](https://github.com/caketop/python-starlark-go) ⭐ 35 | 🐛 19 | 🌐 Python | 📅 2026-08-12 - Python bindings for Starlark in Go.
...
* [Buildifier](https://github.com/bazelbuild/buildtools) ⭐ 1,185 | 🐛 116 | 🌐 Go | 📅 2026-07-16 - The official code formatter &
...
* [Skycfg](https://github.com/stripe/skycfg) ⭐ 674 | 🐛 12 | 🌐 Go | 📅 2026-06-10 - a library for Starlark to
...
* [Starlet](https://github.com/1set/starlet) ⭐ 48 | 🐛 2 | 🌐 Go | 📅 2026-07-13 - a Go wrapper for the [Starlark in Go](https://github.com/google/starlark-go) ⭐ 2,745 | 🐛 76 | 🌐 Go | 📅 2026-07-10 that
...
* [Starpls](https://github.com/withered-magic/starpls) ⭐ 217 | 🐛 77 | 🌐 Rust | 📅 2025-12-03 - a language server
  for Starlark.
...
* [Bazel](https://github.com/bazelbuild/bazel) ⭐ 25,710 | 🐛 1,927 | 🌐 Java | 📅 2026-08-14 - a fast, scalable,
  multi-language and extensible build system. Starlark has been designed for
  Bazel.
* [Delve](https://github.com/go-delve/delve) ⭐ 24,875 | 🐛 86 | 🌐 Go | 📅 2026-08-13 - a debugger for the Go
  programming language, aiming to provide a simple, full featured debugging
  tool for Go. [Delve uses Starlark](https://github.com/go-delve/delve/blob/master/Documentation/cli/starlark.md) ⭐ 24,875 | 🐛 86 | 🌐 Go | 📅 2026-08-13
  as a a scripting language.
* [Copybara](https://github.com/google/copybara) ⭐ 3,795 | 🐛 105 | 🌐 Java | 📅 2026-08-13 - a tool for transforming and
  moving code between repositories. It embeds Starlark to configure the workflow.
* [envd](https://github.com/tensorchord/envd) ⭐ 2,221 | 🐛 139 | 🌐 Go | 📅 2026-07-25 - a CLI to build the docker images
...
* [OpenRun](https://github.com/openrundev/openrun) ⭐ 932 | 🐛 0 | 🌐 Go | 📅 2026-08-14 - web app development and deployment
  platform for internal tools. It allows declarative deployment of applications built
  in any language/framework.
* [Pixlet](https://github.com/tidbyt/pixlet) ⭐ 847 | 🐛 71 | 🌐 Go | 📅 2026-08-11 - a runtime and UX toolkit for generating animations for small LED displays, such as [Tidbyt](https://tidbyt.com/). Starlark is used to write applets whose outputs are WebP animations.
* [realm](https://github.com/spellshift/realm) ⭐ 633 | 🐛 106 | 🌐 Rust | 📅 2026-08-06 - an Adversary Emulation Framework
...
* [Remarshal](https://github.com/remarshal-project/remarshal) ⭐ 550 | 🐛 5 | 🌐 Python | 📅 2026-08-01 - a data format converter
  for CBOR, JSON, MessagePack, TOML, and YAML 1.1 & 1.2. Supports transformations written
  in Starlark.
* [Kurtosis](https://github.com/kurtosis-tech/kurtosis) ⭐ 548 | 🐛 302 | 🌐 Go | 📅 2026-08-11 - a developer tool
...
* [Isopod](https://github.com/cruise-automation/isopod) ⭐ 486 | 🐛 20 | 🌐 Go | 📅 2023-11-17 - created by Cruise
...
* [AsCode](https://github.com/mcuadros/ascode) ⭐ 130 | 🐛 2 | 🌐 Go | 📅 2024-10-21 - a tool to define infrastructure
