...
* [The language specification](https://github.com/bazelbuild/starlark/blob/master/spec.md) ⭐ 3,085 | 🐛 97 | 🌐 Python | 📅 2026-02-06

* There are 4 known implementations of the Starlark language:
  * [starlark/java](https://github.com/bazelbuild/bazel/tree/master/src/main/java/net/starlark/java) ⭐ 25,822 | 🐛 1,777 | 🌐 Java | 📅 2026-09-09 - an implementation in Java
    built for Bazel, that may not be suitable for use in other applications.
  * [starlark-go](https://github.com/google/starlark-go/) ⭐ 2,759 | 🐛 78 | 🌐 Go | 📅 2026-09-08 - an implementation in Go.
  * [starlark-rust](https://github.com/facebookexperimental/starlark-rust) ⭐ 1,018 | 🐛 40 | 🌐 Rust | 📅 2026-09-10 - an implementation in Rust.
...
* Bindings:
  ...
  * [python-starlark-go](https://github.com/caketop/python-starlark-go) ⭐ 35 | 🐛 16 | 🌐 Python | 📅 2026-09-09 - Python bindings for Starlark in Go.
...
* [Buildifier](https://github.com/bazelbuild/buildtools) ⭐ 1,191 | 🐛 123 | 🌐 Go | 📅 2026-09-04 - The official code formatter &
...
* [Skycfg](https://github.com/stripe/skycfg) ⭐ 675 | 🐛 12 | 🌐 Go | 📅 2026-08-14 - a library for Starlark to
...
* [Starlet](https://github.com/1set/starlet) ⭐ 48 | 🐛 2 | 🌐 Go | 📅 2026-07-13 - a Go wrapper for the [Starlark in Go](https://github.com/google/starlark-go) ⭐ 2,759 | 🐛 78 | 🌐 Go | 📅 2026-09-08 that
...
* [Starpls](https://github.com/withered-magic/starpls) ⭐ 218 | 🐛 78 | 🌐 Rust | 📅 2025-12-03 - a language server
  for Starlark.
...
* [Bazel](https://github.com/bazelbuild/bazel) ⭐ 25,822 | 🐛 1,777 | 🌐 Java | 📅 2026-09-09 - a fast, scalable,
  multi-language and extensible build system. Starlark has been designed for
  Bazel.
* [Delve](https://github.com/go-delve/delve) ⭐ 24,914 | 🐛 83 | 🌐 Go | 📅 2026-09-09 - a debugger for the Go
  programming language, aiming to provide a simple, full featured debugging
  tool for Go. [Delve uses Starlark](https://github.com/go-delve/delve/blob/master/Documentation/cli/starlark.md) ⭐ 24,914 | 🐛 83 | 🌐 Go | 📅 2026-09-09
  as a a scripting language.
* [Copybara](https://github.com/google/copybara) ⭐ 3,834 | 🐛 105 | 🌐 Java | 📅 2026-09-08 - a tool for transforming and
...
* [OpenRun](https://github.com/openrundev/openrun) ⭐ 971 | 🐛 1 | 🌐 Go | 📅 2026-09-08 - web app development and deployment
  platform for internal tools. It allows declarative deployment of applications built
  in any language/framework.
* [Pixlet](https://github.com/tidbyt/pixlet) ⭐ 846 | 🐛 73 | 🌐 Go | 📅 2026-09-09 - a runtime and UX toolkit for generating animations for small LED displays, such as [Tidbyt](https://tidbyt.com/). Starlark is used to write applets whose outputs are WebP animations.
...
* [Remarshal](https://github.com/remarshal-project/remarshal) ⭐ 552 | 🐛 5 | 🌐 Python | 📅 2026-08-01 - a data format converter
  ...
  in Starlark.
* [Kurtosis](https://github.com/kurtosis-tech/kurtosis) ⭐ 551 | 🐛 313 | 🌐 Go | 📅 2026-09-09 - a developer tool
